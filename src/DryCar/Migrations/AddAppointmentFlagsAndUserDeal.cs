...
[Migration("20250603142809_AddAppointmentFlagsAndUserDeal")]
public class AddAppointmentFlagsAndUserDeal : Migration
{
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        migrationBuilder.AddColumn<bool>("IsArchived", "Appointments", "bit", null, null, rowVersion: false, null, nullable: false, false);
        migrationBuilder.AddColumn<bool>("IsConfirmed", "Appointments", "bit", null, null, rowVersion: false, null, nullable: false, false);
        migrationBuilder.AddColumn<bool>("HasFreeDeal", "Users", "bit", null, null, rowVersion: false, null, nullable: false, false);
    }

    protected override void Down(MigrationBuilder migrationBuilder)
    {
        migrationBuilder.DropColumn("IsArchived", "Appointments");
        migrationBuilder.DropColumn("IsConfirmed", "Appointments");
        migrationBuilder.DropColumn("HasFreeDeal", "Users");
    }
