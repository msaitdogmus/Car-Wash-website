...
[Migration("20251226172057_AddFreeDealCycleFields")]
public class AddFreeDealCycleFields : Migration
{
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        migrationBuilder.AddColumn<DateTime>("FreeDealRedeemedAt", "Users", "datetime2", null, null, rowVersion: false, null, nullable: true);
        migrationBuilder.AddColumn<int>("FreeDealReservedAppointmentId", "Users", "int", null, null, rowVersion: false, null, nullable: true);
        migrationBuilder.AddColumn<int>("PaidWashCount", "Users", "int", null, null, rowVersion: false, null, nullable: false, 0);
        migrationBuilder.AddColumn<DateTime>("ConfirmedAt", "Appointments", "datetime2", null, null, rowVersion: false, null, nullable: true);
        migrationBuilder.AddColumn<bool>("IsFreeDealApplied", "Appointments", "bit", null, null, rowVersion: false, null, nullable: false, false);
    }

    protected override void Down(MigrationBuilder migrationBuilder)
    {
        migrationBuilder.DropColumn("FreeDealRedeemedAt", "Users");
        migrationBuilder.DropColumn("FreeDealReservedAppointmentId", "Users");
        migrationBuilder.DropColumn("PaidWashCount", "Users");
        migrationBuilder.DropColumn("ConfirmedAt", "Appointments");
        migrationBuilder.DropColumn("IsFreeDealApplied", "Appointments");
    }
