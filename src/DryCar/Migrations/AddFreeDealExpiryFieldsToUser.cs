...
[Migration("20251226160605_AddFreeDealExpiryFieldsToUser")]
public class AddFreeDealExpiryFieldsToUser : Migration
{
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        migrationBuilder.AddColumn<DateTime>("FreeDealExpiresAt", "Users", "datetime2", null, null, rowVersion: false, null, nullable: true);
        migrationBuilder.AddColumn<DateTime>("FreeDealGrantedAt", "Users", "datetime2", null, null, rowVersion: false, null, nullable: true);
        migrationBuilder.AddColumn<DateTime>("FreeDealNotifiedAt", "Users", "datetime2", null, null, rowVersion: false, null, nullable: true);
        migrationBuilder.AddColumn<DateTime>("FreeDealReminderSentAt", "Users", "datetime2", null, null, rowVersion: false, null, nullable: true);
    }

    protected override void Down(MigrationBuilder migrationBuilder)
    {
        migrationBuilder.DropColumn("FreeDealExpiresAt", "Users");
        migrationBuilder.DropColumn("FreeDealGrantedAt", "Users");
        migrationBuilder.DropColumn("FreeDealNotifiedAt", "Users");
        migrationBuilder.DropColumn("FreeDealReminderSentAt", "Users");
    }
