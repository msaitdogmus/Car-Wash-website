...
[Migration("20260118125703_FreeDealMonthlyCycle")]
public class FreeDealMonthlyCycle : Migration
{
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        migrationBuilder.AddColumn<int>("FreeDealBalance", "Users", "int", null, null, rowVersion: false, null, nullable: false, 0);
        migrationBuilder.AddColumn<DateTime>("FreeDealCycleEndAt", "Users", "datetime2", null, null, rowVersion: false, null, nullable: true);
        migrationBuilder.AddColumn<DateTime>("FreeDealCycleStartAt", "Users", "datetime2", null, null, rowVersion: false, null, nullable: true);
        migrationBuilder.AddColumn<int>("FreeDealsGrantedInCycle", "Users", "int", null, null, rowVersion: false, null, nullable: false, 0);
        migrationBuilder.AddColumn<int>("PaidWashCountInCycle", "Users", "int", null, null, rowVersion: false, null, nullable: false, 0);
    }

    protected override void Down(MigrationBuilder migrationBuilder)
    {
        migrationBuilder.DropColumn("FreeDealBalance", "Users");
        migrationBuilder.DropColumn("FreeDealCycleEndAt", "Users");
        migrationBuilder.DropColumn("FreeDealCycleStartAt", "Users");
        migrationBuilder.DropColumn("FreeDealsGrantedInCycle", "Users");
        migrationBuilder.DropColumn("PaidWashCountInCycle", "Users");
    }
